		...
		<a-layout-header>
			<a-row type="flex">
				...
				<a-col :span="24" :md="6">
					...
					<!-- Header Breadcrumbs -->
					<a-breadcrumb>
						<a-breadcrumb-item><router-link to="/"> صفحه</router-link></a-breadcrumb-item>
				...
				<a-col :span="24" :md="18" class="header-control">
					...
					<!-- Header Search Input -->
					<a-input-search class="header-search" :class="searchLoading ? 'loading' : ''" placeholder="جستجو کنید... " @search="onSearch" :loading='searchLoading'>
...
<script>
	...
	const notificationsData = [
		{
			title: 'یک پیام جدید از سوفی دارید',
