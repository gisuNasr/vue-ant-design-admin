<template>
	...
	>
		...
		<div class="drawer-content">
			<h6>پیکربندی</h6>
			<p>گزینه های داشبورد ما را ببینید.</p>
			<hr>
			<div class="sidebar-color">
				<h6>رنگ نوار کناری</h6>
				<a-radio-group v-model="sidebarColorModel" @change="$emit('updateSidebarColor', $event.target.value)" defaultValue="danger">
			...
			<div class="sidenav-type">
				<h6>نوع Sidenav</h6>
				<p>بین 2 نوع نوار کناری مختلف را انتخاب کنید.</p>
				<a-radio-group button-style="solid" v-model="sidebarThemeModel" @change="$emit('updateSidebarTheme', $event.target.value)" defaultValue="primary">
					<a-radio-button value="light">شفاف</a-radio-button>
					<a-radio-button value="white">سفید</a-radio-button>
				</a-radio-group>
			</div>
			<div class="navbar-fixed">
				<h6>نوار ناوبری ثابت شد</h6>
			...
			<div class="sharing">
				<h6>با تشکر از شما برای به اشتراک گذاری!</h6>
