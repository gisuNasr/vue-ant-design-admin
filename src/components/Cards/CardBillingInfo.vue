<template>
	...
	<a-card :bordered="false" class="header-solid h-full" :bodyStyle="{paddingTop: 0, paddingBottom: '16px' }">
		<template #title>
			<h6 class="font-semibold m-0">اطلاعات صورتحساب </h6>
		</template>
		<a-row :gutter="[24, 24]">
			<a-col :span="24">
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="اولیور لیام " :column="1">
						<a-descriptions-item label="نام کمپانی">
							وایکینگ بوریتو
						</a-descriptions-item>
						<a-descriptions-item label="آدرس ایمیل ">
							oliver@burrito.com
						</a-descriptions-item>
						<a-descriptions-item label="شماره فاکتور ">
							FRB1235476
						</a-descriptions-item>
					</a-descriptions>
				</div>
				<div class="col-action">
					...
					<a-button type="link" size="small">
						...
						<span class="text-dark">ویرایش</span>
					</a-button>
				</div>
			</a-card>
			</a-col>
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="لوکاس هارپر " :column="1">
						<a-descriptions-item label="نام کمپانی">
							استون تک
						</a-descriptions-item>
						<a-descriptions-item label="آدرس ایمیل ">
