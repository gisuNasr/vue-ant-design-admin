		...
		<a-row type="flex">
			<a-col :span="24" :md="12">
				...
				<p class="copyright">
					...
					<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					 ...
					 <a href="https://creative-tim.com">Creative Tim</a> برای توسعه بهتر
				</p>
				<!-- / Footer Copyright Notice -->
			...
			<a-col :span="24" :md="12" class="footer-control">
				...
				<a-menu mode="horizontal">
					<a-menu-item>تیم خلاق</a-menu-item>
					<a-menu-item>درباره ما</a-menu-item>
					<a-menu-item>بلاگ</a-menu-item>
					<a-menu-item>لایسنس</a-menu-item>
				</a-menu>
				<!-- / Footer Navigation Menu -->
