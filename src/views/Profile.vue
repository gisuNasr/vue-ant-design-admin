...
<template>
	<div>
				...
				<a-row type="flex" align="middle">
					<a-col :span="24" :md="12" class="col-info">
						...
						<div class="avatar-info">
							<h4 class="font-semibold m-0"> گیسو نصر</h4>
							<p>مدیرعامل /بنیان گذار</p>
						</div>
					</a-col>
					<a-col :span="24" :md="12" style="display: flex; align-items: center; justify-content: flex-end">
						<a-radio-group v-model="profileHeaderBtns" size="small">
							<a-radio-button value="overview">بررسی اجمالی</a-radio-button>
							<a-radio-button value="teams">تیم ها</a-radio-button>
							<a-radio-button value="projects">پروژه ها</a-radio-button>
						</a-radio-group>
					</a-col>
				</a-row>
			</template>
		...
		<a-card :bordered="false" class="header-solid h-full mb-24" :bodyStyle="{paddingTop: '14px'}">
			<template #title>
				<h6 class="font-semibold">پروژه ها</h6>			
				<p>معماران خانه ها را طراحی می کنند</p>	
			</template>
	...
	const conversationsData = [
		{
			id: "1",
			title: "سوفیا",
			code: "سلام! من به اطلاعات بیشتری نیاز دارم...",
			avatar: "images/face-3.jpg",
		},
		{
			id: "2",
			title: "انه ماری",
			code: "عالی،میتونی این کارو...",
			avatar: "images/face-4.jpg",
		},
		{
			id: "3",
			title: "ایوان",
			code: "در مورد فایل ها من میتونم ...",
			avatar: "images/face-5.jpeg",
		},
		{
			id: "4",
			title: "پیتوسون",
			code: "بعدازظهر خوبی داشته باشی!",
